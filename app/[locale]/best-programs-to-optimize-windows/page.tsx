...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        keywords: [],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/best-programs-to-optimize-windows`,
            languages: {
                'en': `/en/best-programs-to-optimize-windows`,
                'es': `/es/best-programs-to-optimize-windows`,
                'pt-br': `/pt-br/best-programs-to-optimize-windows`,
                'de': `/de/best-programs-to-optimize-windows`,
                'fr': `/fr/best-programs-to-optimize-windows`,
                'it': `/it/best-programs-to-optimize-windows`,
                'ja': `/ja/best-programs-to-optimize-windows`,
                'ko': `/ko/best-programs-to-optimize-windows`,
                'ar': `/ar/best-programs-to-optimize-windows`
            }
        }
    };
}
