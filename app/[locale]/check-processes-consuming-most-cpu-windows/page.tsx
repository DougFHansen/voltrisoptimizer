...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Check Processes Consuming Most CPU in Windows 11 (2026)`,
        description: `Is your PC slow for no reason? Learn how to identify and eliminate processes that are unnecessarily consuming CPU in Windows 11, using Task Manager and advanced tools.`,
        keywords: ['check high cpu processes windows 11', 'how to see what consumes cpu windows', 'process consuming 100 cpu windows 11', 'voltris diagnostic deep scan', 'identify heavy process windows', 'task using too much cpu solution'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/check-processes-consuming-most-cpu-windows`,
            languages: {
                'en': `/en/check-processes-consuming-most-cpu-windows`,
                'es': `/es/check-processes-consuming-most-cpu-windows`,
                'pt-br': `/pt-br/check-processes-consuming-most-cpu-windows`,
                'de': `/de/check-processes-consuming-most-cpu-windows`,
                'fr': `/fr/check-processes-consuming-most-cpu-windows`,
                'it': `/it/check-processes-consuming-most-cpu-windows`,
                'ja': `/ja/check-processes-consuming-most-cpu-windows`,
                'ko': `/ko/check-processes-consuming-most-cpu-windows`,
                'ar': `/ar/check-processes-consuming-most-cpu-windows`
            }
        }
    };
}
