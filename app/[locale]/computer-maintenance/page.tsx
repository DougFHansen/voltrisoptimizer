...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  robots: {
    ...
    googleBot: { index: true, follow: true, 'max-video-preview': -1, 'max-image-preview': 'large', 'max-snippet': -1 },
        ...
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/computer-maintenance`,
            languages: {
                'en': `/en/computer-maintenance`,
                'es': `/es/computer-maintenance`,
                'pt-br': `/pt-br/computer-maintenance`,
                'de': `/de/computer-maintenance`,
                'fr': `/fr/computer-maintenance`,
                'it': `/it/computer-maintenance`,
                'ja': `/ja/computer-maintenance`,
                'ko': `/ko/computer-maintenance`,
                'ar': `/ar/computer-maintenance`
            }
        }
    };
}
