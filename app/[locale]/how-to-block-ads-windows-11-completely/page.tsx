...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Block All Ads on Windows 11 | Definitive Guide 2026`,
        description: `Is Windows 11 full of ads? Learn how to permanently remove ads from the Start Menu, File Explorer, and Lock Screen for free.`,
        keywords: ['block windows 11 start menu ads', 'remove windows 11 ads permanently', 'disable explorer ads windows 11', 'voltris optimizer adblocker', 'clean windows 11 ads', 'how to remove microsoft app suggestions'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/how-to-block-ads-windows-11-completely`,
            languages: {
                'en': `/en/how-to-block-ads-windows-11-completely`,
                'es': `/es/how-to-block-ads-windows-11-completely`,
                'pt-br': `/pt-br/how-to-block-ads-windows-11-completely`,
                'de': `/de/how-to-block-ads-windows-11-completely`,
                'fr': `/fr/how-to-block-ads-windows-11-completely`,
                'it': `/it/how-to-block-ads-windows-11-completely`,
                'ja': `/ja/how-to-block-ads-windows-11-completely`,
                'ko': `/ko/how-to-block-ads-windows-11-completely`,
                'ar': `/ar/how-to-block-ads-windows-11-completely`
            }
        }
    };
}
