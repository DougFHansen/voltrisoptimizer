...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Clear the Recent Files List on Windows 11 (Privacy 2026)`,
        description: `Worried about who can see your recently opened files? Learn how to clear and disable recent file history on Windows 11 via Explorer, Start Menu, and Taskbar.`,
        keywords: ['clear recent files windows 11', 'disable file history windows 11', 'remove recent files list explorer', 'voltris privacy shield files', 'how to hide opened files windows', 'delete document history windows'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/how-to-clear-recent-files-list-windows-11`,
            languages: {
                'en': `/en/how-to-clear-recent-files-list-windows-11`,
                'es': `/es/how-to-clear-recent-files-list-windows-11`,
                'pt-br': `/pt-br/how-to-clear-recent-files-list-windows-11`,
                'de': `/de/how-to-clear-recent-files-list-windows-11`,
                'fr': `/fr/how-to-clear-recent-files-list-windows-11`,
                'it': `/it/how-to-clear-recent-files-list-windows-11`,
                'ja': `/ja/how-to-clear-recent-files-list-windows-11`,
                'ko': `/ko/how-to-clear-recent-files-list-windows-11`,
                'ar': `/ar/how-to-clear-recent-files-list-windows-11`
            }
        }
    };
}
