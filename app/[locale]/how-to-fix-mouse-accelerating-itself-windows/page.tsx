...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Fix Mouse Acceleration on Windows 11 (2026)`,
        description: `Is your cursor moving strangely or accelerating out of control? Learn how to disable mouse acceleration on Windows 11 for true 1:1 pointer tracking and better aiming in games.`,
        keywords: ['how to disable mouse acceleration windows 11', 'mouse accelerating on its own fix', 'imprecise mouse pointer windows 11', 'voltris latency optimizer mouse', 'enhance pointer precision off windows', 'configure gaming mouse sensitivity'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/how-to-fix-mouse-accelerating-itself-windows`,
            languages: {
                'en': `/en/how-to-fix-mouse-accelerating-itself-windows`,
                'es': `/es/how-to-fix-mouse-accelerating-itself-windows`,
                'pt-br': `/pt-br/how-to-fix-mouse-accelerating-itself-windows`,
                'de': `/de/how-to-fix-mouse-accelerating-itself-windows`,
                'fr': `/fr/how-to-fix-mouse-accelerating-itself-windows`,
                'it': `/it/how-to-fix-mouse-accelerating-itself-windows`,
                'ja': `/ja/how-to-fix-mouse-accelerating-itself-windows`,
                'ko': `/ko/how-to-fix-mouse-accelerating-itself-windows`,
                'ar': `/ar/how-to-fix-mouse-accelerating-itself-windows`
            }
        }
    };
}
