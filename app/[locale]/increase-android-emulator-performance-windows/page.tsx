...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Boost Android Emulator Performance on Windows 11 (2026)`,
        description: `Is your Bluestacks or LDPlayer lagging? Learn how to optimize Windows to get more FPS in Android emulators, configure virtualization correctly, and reduce RAM usage.`,
        keywords: ['increase fps emulator bluestacks', 'improve android emulator performance pc', 'slow emulator windows 11 fix', 'voltris optimizer emulator', 'configure virtualization windows 11 emulator', 'ldplayer freezing windows fix'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/increase-android-emulator-performance-windows`,
            languages: {
                'en': `/en/increase-android-emulator-performance-windows`,
                'es': `/es/increase-android-emulator-performance-windows`,
                'pt-br': `/pt-br/increase-android-emulator-performance-windows`,
                'de': `/de/increase-android-emulator-performance-windows`,
                'fr': `/fr/increase-android-emulator-performance-windows`,
                'it': `/it/increase-android-emulator-performance-windows`,
                'ja': `/ja/increase-android-emulator-performance-windows`,
                'ko': `/ko/increase-android-emulator-performance-windows`,
                'ar': `/ar/increase-android-emulator-performance-windows`
            }
        }
    };
}
