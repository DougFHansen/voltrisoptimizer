...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/optimize-windows-11-for-valorant`,
            languages: {
                'en': `/en/optimize-windows-11-for-valorant`,
                'es': `/es/optimize-windows-11-for-valorant`,
                'pt-br': `/pt-br/optimize-windows-11-for-valorant`,
                'de': `/de/optimize-windows-11-for-valorant`,
                'fr': `/fr/optimize-windows-11-for-valorant`,
                'it': `/it/optimize-windows-11-for-valorant`,
                'ja': `/ja/optimize-windows-11-for-valorant`,
                'ko': `/ko/optimize-windows-11-for-valorant`,
                'ar': `/ar/optimize-windows-11-for-valorant`
            }
        }
    };
}
