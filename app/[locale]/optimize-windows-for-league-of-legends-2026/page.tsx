...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Optimize Windows 11 for League of Legends (2026) | Maximum FPS`,
        description: `Is your LoL game lagging? Learn how to optimize Windows 11 for stable FPS in League of Legends, reduce ping, and eliminate client stuttering.`,
        keywords: ['optimize windows 11 league of legends', 'increase fps lol 2026 windows', 'how to remove lag league of legends pc', 'voltris optimizer lol performance', 'best settings league of legends windows', 'league of legends client slow fix'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/optimize-windows-for-league-of-legends-2026`,
            languages: {
                'en': `/en/optimize-windows-for-league-of-legends-2026`,
                'es': `/es/optimize-windows-for-league-of-legends-2026`,
                'pt-br': `/pt-br/optimize-windows-for-league-of-legends-2026`,
                'de': `/de/optimize-windows-for-league-of-legends-2026`,
                'fr': `/fr/optimize-windows-for-league-of-legends-2026`,
                'it': `/it/optimize-windows-for-league-of-legends-2026`,
                'ja': `/ja/optimize-windows-for-league-of-legends-2026`,
                'ko': `/ko/optimize-windows-for-league-of-legends-2026`,
                'ar': `/ar/optimize-windows-for-league-of-legends-2026`
            }
        }
    };
}
