...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Optimize Windows 11 for Streaming (Twitch/YouTube) (2026)`,
        description: `Is your live stream freezing? Learn how to configure Windows 11 for smooth streaming, optimize OBS Studio, and guarantee zero frame drops during your live broadcasts.`,
        keywords: ['optimize windows 11 for twitch streaming', 'eliminate lag obs studio windows', 'improve encoder performance pc', 'voltris optimizer streamer build', 'configure pc for lag-free streaming', 'windows 11 settings youtube streaming'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/optimize-windows-for-streaming-twitch-youtube`,
            languages: {
                'en': `/en/optimize-windows-for-streaming-twitch-youtube`,
                'es': `/es/optimize-windows-for-streaming-twitch-youtube`,
                'pt-br': `/pt-br/optimize-windows-for-streaming-twitch-youtube`,
                'de': `/de/optimize-windows-for-streaming-twitch-youtube`,
                'fr': `/fr/optimize-windows-for-streaming-twitch-youtube`,
                'it': `/it/optimize-windows-for-streaming-twitch-youtube`,
                'ja': `/ja/optimize-windows-for-streaming-twitch-youtube`,
                'ko': `/ko/optimize-windows-for-streaming-twitch-youtube`,
                'ar': `/ar/optimize-windows-for-streaming-twitch-youtube`
            }
        }
    };
}
