...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `How to Reduce Network Latency (Ping) in Online Games on Windows 11 (2026)`,
        description: `Professional guide to stabilize your network signal. Learn how to disable Nagle`,
        keywords: ['reduce network latency online games', 'how to lower ping windows 11', 'optimize gaming network', 'voltris network optimizer', 'disable nagles algorithm windows', 'tcp ack frequency tweak'],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/reduce-network-latency-online-games`,
            languages: {
                'en': `/en/reduce-network-latency-online-games`,
                'es': `/es/reduce-network-latency-online-games`,
                'pt-br': `/pt-br/reduce-network-latency-online-games`,
                'de': `/de/reduce-network-latency-online-games`,
                'fr': `/fr/reduce-network-latency-online-games`,
                'it': `/it/reduce-network-latency-online-games`,
                'ja': `/ja/reduce-network-latency-online-games`,
                'ko': `/ko/reduce-network-latency-online-games`,
                'ar': `/ar/reduce-network-latency-online-games`
            }
        }
    };
}
