...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        keywords: [],
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/remove-bloatware-windows-11`,
            languages: {
                'en': `/en/remove-bloatware-windows-11`,
                'es': `/es/remove-bloatware-windows-11`,
                'pt-br': `/pt-br/remove-bloatware-windows-11`,
                'de': `/de/remove-bloatware-windows-11`,
                'fr': `/fr/remove-bloatware-windows-11`,
                'it': `/it/remove-bloatware-windows-11`,
                'ja': `/ja/remove-bloatware-windows-11`,
                'ko': `/ko/remove-bloatware-windows-11`,
                'ar': `/ar/remove-bloatware-windows-11`
            }
        }
    };
}
