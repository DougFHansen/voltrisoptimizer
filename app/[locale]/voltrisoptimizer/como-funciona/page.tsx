...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    openGraph: {
        ...
        alternates: {
            canonical: `https://www.voltrisoptimizer.com/${locale}/voltrisoptimizer/como-funciona`,
            languages: {
                'en': `/en/voltrisoptimizer/como-funciona`,
                'es': `/es/voltrisoptimizer/como-funciona`,
                'pt-br': `/pt-br/voltrisoptimizer/como-funciona`,
                'de': `/de/voltrisoptimizer/como-funciona`,
                'fr': `/fr/voltrisoptimizer/como-funciona`,
                'it': `/it/voltrisoptimizer/como-funciona`,
                'ja': `/ja/voltrisoptimizer/como-funciona`,
                'ko': `/ko/voltrisoptimizer/como-funciona`,
                'ar': `/ar/voltrisoptimizer/como-funciona`
            }
        }
    };
}
