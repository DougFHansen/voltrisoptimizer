...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: '[2026] Premium IT Services for Expatriates Worldwide - VOLTRIS',
    description: '✓ 6 specialized services in English & Portuguese ✓ Remote tech support, formatting and optimization ✓ 24/7 support for expats ✓ Prices in EUR/USD ✓ International quality guaranteed',
    images: [
      {
        url: '/images/services-international-og.jpg',
        width: 1200,
        height: 630,
        alt: 'Premium IT Services for Expatriates - VOLTRIS',
      },
    ],
  },
  twitter: {
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
              <h3 className="text-xl font-bold text-white mb-3">
                What is the difference between local and international remote support?
              </h3>
              <p className="text-gray-400 leading-relaxed">
                International remote support offers significant advantages: access to specialized professionals 
                regardless of your geographic location, support in your preferred language with cultural understanding of your needs, 
                generally more competitive prices than local shops abroad, and the convenience of solving problems without leaving your home. 
                VOLTRIS combines high-quality service with the practicality of remote support.
              </p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
              <h3 className="text-xl font-bold text-white mb-3">
                How is my data security handled during remote support?
              </h3>
              <p className="text-gray-400 leading-relaxed">
                We implement multiple layers of security: all connections use 256-bit SSL/TLS encryption, 
                require two-factor authentication, are recorded in audit logs, and our technicians follow strict privacy protocols. 
                Furthermore, you maintain full control throughout the process and can end the session at any time. 
                We ensure compliance with international information security best practices.
              </p>
            </div>
          </div>
        </div>
