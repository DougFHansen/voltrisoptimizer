      ...
      <div className="m-4 w-full max-w-2xl bg-gradient-to-r from-[#1c1c1e] via-[#8B31FF] to-[#31A8FF] text-white rounded-2xl shadow-2xl p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 pointer-events-auto border border-white/10 backdrop-blur-md animate-fadeIn">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className="block text-sm text-white/80 whitespace-normal break-words">We use cookies to improve your experience. By continuing, you agree to our <Link href='/en/privacy-policy' className='underline hover:text-white transition'>Privacy Policy</Link>.</span>
          </div>
        </div>
        <button
