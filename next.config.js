...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/politica-privacidade', destination: '/en/privacy-policy', permanent: true },
      { source: '/termos-uso', destination: '/en/terms-of-use', permanent: true },
      { source: '/politica-reembolso', destination: '/en/refund-policy', permanent: true },
